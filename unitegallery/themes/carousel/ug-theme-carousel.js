...
function UGTheme_carousel(){
    ...
    var g_options = {
            ...
            theme_carousel_offset: 0,                //the offset of the carousel from the align sides - смещение карусели от выравнивания сторон

            theme_enable_navigation: true,
            theme_navigation_position: "bottom",    //top,bottom: the vertical position of the navigation reative to the carousel
            theme_navigation_enable_play: true,        //enable / disable the play button of the navigation  -  включить / отключить кнопку воспроизведения, навигационной
            theme_navigation_align: "center",        //the align of the navigation
            theme_navigation_offset_hor: 0,            //horizontal offset of the navigation - горизонтальное смещение навигации
            theme_navigation_margin: 5,            //the space between the carousel and the navigation - пространство между каруселью и навигации
            theme_space_between_arrows: 5            //the space between arrows in the navigation - пространство между стрелками в навигации
    };
